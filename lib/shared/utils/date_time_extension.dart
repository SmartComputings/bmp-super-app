...
extension DateTimeExtension on DateTime {
  ...
  String localizedTimeOfDay(BuildContext context) =>
      // L10n.of(context).alwaysUse24HourFormat == 'true' ? 
          // DateFormat('HH:mm', L10n.of(context).localeName).format(this); // 24-hour format commented out
          DateFormat('h:mm a', 'en_US').format(this); // 12-hour AM/PM format like WhatsApp
