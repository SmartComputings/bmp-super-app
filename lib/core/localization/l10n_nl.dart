...
class L10nNl extends L10n {
  ...
  String get confirmMatrixId =>
      'Bevestig jouw user-ID om je account te verwijderen.';
  ...
  String inviteText(String username, String link) {
    return '$username heeft je uitgenodigd voor BMP.\n1. Registreer of log in\n2. Open deze uitnodigingslink:\n$link';
  }
  ...
  String get wrongPinEntered =>
      'Verkeerde pin ingevoerd! Probeer het nog eens over null seconden...';
  ...
  String get homeserverDescription =>
      'Al je data is opgeslagen op de server, net als bij een email-leverancier. Je kan kiezen welke server je gebruikt en toch communiceren met iedereen. Lees meer op https://invitation.be-mindpower.net/.';
  ...
  String get welcomeText =>
      'Hallo hallo 👋 Dit is FluffyChat. Je kan inloggen op elke server die werkt met https://invitation.be-mindpower.net/. En dan chat je met iedereen. Het is een groot decentraal chat-netwerk!';
  ...
  String get appIntroduction =>
      'FluffyChat laat je chatten met je vrienden tussen verschillende chat-netwerken. Lees meer op https://invitation.be-mindpower.net/ of tik *Continue*.';
