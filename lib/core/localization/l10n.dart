...
abstract class L10n {
  ...
  ///
  /// In en, this message translates to:
  /// **'Please confirm your user ID in order to delete your account.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Unlock the true potential of your community'**
  String get paywallSubtitle;

  /// No description provided for @firstMonthLabel.
  ///
  /// In en, this message translates to:
  /// **'First month free'**
  String get firstMonthLabel;

  /// No description provided for @thenEnjoyMemberPriceLabel.
  ///
  /// In en, this message translates to:
  /// **'Then enjoy our member price'**
  String get thenEnjoyMemberPriceLabel;

  /// No description provided for @usdMonthLabel.
  ///
  /// In en, this message translates to:
  /// **'USD/mo'**
  String get usdMonthLabel;

  /// No description provided for @yearlyPlanOfferLabel.
  ///
  /// In en, this message translates to:
  /// **'Annual plan, 1 month free included'**
  String get yearlyPlanOfferLabel;
  ...
  String get confirmSelectionLabel;
  ...
  /// No description provided for @thisMonthIsOnUs.
  ///
  /// In en, this message translates to:
  /// **'This month is on us'**
  String get thisMonthIsOnUs;

  /// No description provided for @ifYouLoveItContinueFor.
  ///
  /// In en, this message translates to:
  /// **'If you love it, continue for'**
  String get ifYouLoveItContinueFor;

  /// No description provided for @thenEnjoyMemberPriceForJust.
  ///
  /// In en, this message translates to:
  /// **'Then enjoy a member price for just'**
  String get thenEnjoyMemberPriceForJust;

  /// No description provided for @usdMonth.
  ///
  /// In en, this message translates to:
  /// **'USD month'**
  String get usdMonth;

  /// No description provided for @yearlyPlanOfferText.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @orPayWithCard.
  ///
  /// In en, this message translates to:
  /// **'OR PAY WITH CARD'**
  ...
  /// No description provided for @invalidCardDetails.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @financeDepositSuccessful.
  ///
  /// In en, this message translates to:
  /// **'Deposit successful'**
  String get financeDepositSuccessful;
  ...
  /// No description provided for @financeTransferDetails.
  ///
  /// In en, this message translates to:
  /// **'Transfer details'**
  String get financeTransferDetails;

  /// No description provided for @financeVirtualAccount.
  ///
  /// In en, this message translates to:
  /// **'Virtual Account'**
  String get financeVirtualAccount;

  /// No description provided for @financeDepositReceived.
  ///
  /// In en, this message translates to:
  /// **'Deposit Received'**
  String get financeDepositReceived;
  ...
  /// No description provided for @financeOTPExpired.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @settingUpYourGroup.
  ///
  /// In en, this message translates to:
  /// **'Setting up your group {groupName}'**
  ...
  /// No description provided for @yourGroupIsReady.
  ///
  /// In en, this message translates to:
  /// **'Your group \'{groupName}\' is ready'**
  ...
  /// No description provided for @loginOnboardingNote.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @enterEmailOrUsernameToContinue.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @linkPhoneToSecureAccount.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'El número de teléfono debe tener al menos {requiredLength} dígitos'**
  ...
  /// No description provided for @noExternalAccountAdded.
  ///
  /// In en, this message translates to:
  /// **'No External account added'**
  String get noExternalAccountAdded;
  ...
  /// No description provided for @channelCreatedSuccess.
  ///
  /// In en, this message translates to:
  /// **'Channel has been successfully created'**
  String get channelCreatedSuccess;

  /// No description provided for @channelCreatedFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to create channel'**
  String get channelCreatedFailed;

  /// No description provided for @channelNameEmpty.
  ///
  /// In en, this message translates to:
  /// **'Channel name cannot be empty'**
  String get channelNameEmpty;

  /// No description provided for @channelNameExists.
  ///
  /// In en, this message translates to:
  /// **'Channel name already exists in this group'**
  String get channelNameExists;
  ...
  /// No description provided for @loadLiquidationAddressFailed.
  ///
  /// In en, this message translates to:
  /// **'Load liquidation address details failed: {error}'**
  String loadLiquidationAddressFailed(Object error);

  /// No description provided for @invalidExternalAccountAddress.
  ///
  /// In en, this message translates to:
  /// **'The address for this external account is invalid'**
  String get invalidExternalAccountAddress;

  /// No description provided for @customerIdCheck.
  ///
  /// In en, this message translates to:
  /// **'Customer ID check'**
  String get customerIdCheck;

  /// No description provided for @customerIdNotFound.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @liquidationAddressPayload.
  ///
  /// In en, this message translates to:
  /// **'Liquidation Address Payload'**
  String get liquidationAddressPayload;

  /// No description provided for @failedToCreateLiquidationAddress.
  ///
  /// In en, this message translates to:
  /// **'Failed to create liquidation address'**
  String get failedToCreateLiquidationAddress;

  /// No description provided for @liquidationCreationFailed.
  ///
  /// In en, this message translates to:
  /// **'Liquidation creation failed'**
  String get liquidationCreationFailed;

  /// No description provided for @networkErrorWithMessage.
  ///
  /// In en, this message translates to:
  /// **'Network error: {error}'**
  String networkErrorWithMessage(Object error);

  /// No description provided for @createLiquidationAddressFailedWithMessage.
  ///
  /// In en, this message translates to:
  /// **'Create liquidation address failed: {error}'**
  ...
  /// No description provided for @wrongPinEnteredWithCooldown.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reEnter4DigitPin.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @dialerConnecting.
  ///
  /// In en, this message translates to:
  /// **'Connecting...'**
  String get dialerConnecting;

  /// No description provided for @dialerReconnecting.
  ///
  /// In en, this message translates to:
  /// **'Reconnecting...'**
  String get dialerReconnecting;

  /// No description provided for @dialerReconnectingMessage.
  ///
  /// In en, this message translates to:
  /// **'Please wait while we restore the connection'**
  String get dialerReconnectingMessage;

  /// No description provided for @dialerRinging.
  ///
  /// In en, this message translates to:
  /// **'Ringing...'**
  String get dialerRinging;

  /// No description provided for @dialerCalling.
  ///
  /// In en, this message translates to:
  /// **'Calling...'**
  String get dialerCalling;

  /// No description provided for @dialerVideoCalling.
  ///
  /// In en, this message translates to:
  /// **'Video calling...'**
  String get dialerVideoCalling;

  /// No description provided for @dialerIncomingVoiceCall.
  ///
  /// In en, this message translates to:
  /// **'Incoming voice call...'**
  String get dialerIncomingVoiceCall;

  /// No description provided for @dialerIncomingVideoCall.
  ///
  /// In en, this message translates to:
  /// **'Incoming video call...'**
  String get dialerIncomingVideoCall;

  /// No description provided for @dialerIncomingCall.
  ///
  /// In en, this message translates to:
  /// **'Incoming Call'**
  String get dialerIncomingCall;

  /// No description provided for @dialerMuted.
  ///
  /// In en, this message translates to:
  /// **'Muted'**
  String get dialerMuted;

  /// No description provided for @dialerUnknown.
  ///
  /// In en, this message translates to:
  /// **'Unknown'**
  String get dialerUnknown;

  /// No description provided for @networkQualityExcellent.
  ///
  /// In en, this message translates to:
  /// **'Excellent'**
  String get networkQualityExcellent;

  /// No description provided for @networkQualityGood.
  ///
  /// In en, this message translates to:
  /// **'Good'**
  String get networkQualityGood;

  /// No description provided for @networkQualityFair.
  ///
  /// In en, this message translates to:
  /// **'Fair'**
  String get networkQualityFair;

  /// No description provided for @networkQualityPoor.
  ///
  /// In en, this message translates to:
  /// **'Poor'**
  String get networkQualityPoor;

  /// No description provided for @networkQualityDisconnected.
  ///
  /// In en, this message translates to:
  /// **'Disconnected'**
  String get networkQualityDisconnected;
  ...
  /// No description provided for @subscriptionActivating.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @provideDetailsToContinu.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @failedToLoadPricingPlans.
  ///
  /// In en, this message translates to:
  /// **'Failed to load pricing plans'**
  String get failedToLoadPricingPlans;
  ...
  ///
  /// In en, this message translates to:
  /// **'Subscribe to unlock {feature} and all other premium features.'**
  ...
  /// No description provided for @cancelAnyTimeRecurringBilling.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @cancelSubscriptionSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reactivateSubscriptionSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @noActiveSubscriptionToCancel.
  ///
  /// In en, this message translates to:
  /// **'No active subscription found to cancel'**
  String get noActiveSubscriptionToCancel;

  /// No description provided for @subscriptionCancelledAtPeriodEnd.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @noSubscriptionToReactivate.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @subscriptionWillEndOn.
  ///
  /// In en, this message translates to:
  /// **'Your subscription will end on {date}. You will have access to premium features until then. After that, you will lose access to premium features.'**
  ...
  /// No description provided for @subscriptionWillContinue.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @keepCancelled.
  ///
  /// In en, this message translates to:
  /// **'Keep Cancelled'**
  String get keepCancelled;
  ...
  /// No description provided for @subscriptionStatusCancelling.
  ///
  /// In en, this message translates to:
  /// **'Cancelling'**
  String get subscriptionStatusCancelling;
  ...
  /// No description provided for @subscriptionStatusPaymentPending.
  ///
  /// In en, this message translates to:
  /// **'Payment Pending'**
  String get subscriptionStatusPaymentPending;

  /// No description provided for @subscriptionStatusPaymentOverdue.
  ///
  /// In en, this message translates to:
  /// **'Payment Overdue'**
  String get subscriptionStatusPaymentOverdue;
  ...
  /// No description provided for @subscriptionDescCancelling.
  ///
  /// In en, this message translates to:
  /// **'Your subscription is scheduled for cancellation. You still have access for {days} more days. You can reactivate anytime before it ends.'**
  String subscriptionDescCancelling(int days);

  /// No description provided for @subscriptionDescActive.
  ///
  /// In en, this message translates to:
  /// **'You have full access to all premium features. Enjoy your subscription!'**
  String get subscriptionDescActive;

  /// No description provided for @subscriptionDescTrial.
  ///
  /// In en, this message translates to:
  /// **'You are currently on a free trial. Subscribe to premium to unlock all features.'**
  String get subscriptionDescTrial;

  /// No description provided for @subscriptionDescCancelled.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @subscriptionDescExpired.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @subscriptionDescIncomplete.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @subscriptionDescPastDue.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @subscriptionDescDefault.
  ///
  /// In en, this message translates to:
  /// **'Subscribe to unlock premium features and get the most out of your experience.'**
  String get subscriptionDescDefault;

  /// No description provided for @failedToInitiateRegistration.
  ///
  /// In en, this message translates to:
  /// **'Failed to initiate registration'**
  String get failedToInitiateRegistration;
  ...
  /// No description provided for @supportPageSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @supportCharacterCount.
  ///
  /// In en, this message translates to:
  /// **'{count} characters'**
  ...
  /// No description provided for @selectYourCardType.
  ///
  /// In en, this message translates to:
  /// **'Select your card type'**
  String get selectYourCardType;
  ...
  /// No description provided for @confirmCardSelection.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @mastercardDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @visaDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @selectMastercardType.
  ///
  /// In en, this message translates to:
  /// **'Select Mastercard\ntype'**
  String get selectMastercardType;

  /// No description provided for @selectCardTypeForNewCard.
  ///
  /// In en, this message translates to:
  /// **'Select card type for your new card'**
  ...
  /// No description provided for @allCardTypesAlreadyCreated.
  ///
  /// In en, this message translates to:
  /// **'You have already created all available cards of this type'**
  String get allCardTypesAlreadyCreated;

  /// No description provided for @errorCheckingKycStatus.
  ///
  /// In en, this message translates to:
  /// **'Error checking KYC status'**
  String get errorCheckingKycStatus;

  /// No description provided for @financePayCryptoAccountRequired.
  ///
  /// In en, this message translates to:
  /// **'PayCrypto account is required'**
  ...
  /// No description provided for @notAValidQrCode.
  ///
  /// In en, this message translates to:
  /// **'Not a valid QR code'**
  String get notAValidQrCode;
  ...
  ///
  /// In en, this message translates to:
  /// **'This card is now your default card'**
  ...
  /// No description provided for @enterPinToViewBalance.
  ///
  /// In en, this message translates to:
  /// **'Enter your PIN to view balance'**
  String get enterPinToViewBalance;
  ...
  /// No description provided for @supportDescriptionMinLength.
  ///
  /// In en, this message translates to:
  /// **'Description should be at least 20 characters'**
  String get supportDescriptionMinLength;

  /// No description provided for @paymentsSecurelyProcessedBy.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @inactiveCards.
  ///
  /// In en, this message translates to:
  /// **'Inactive Cards'**
  String get inactiveCards;

  /// No description provided for @freezeCards.
  ///
  /// In en, this message translates to:
  /// **'Freeze Cards'**
  String get freezeCards;

  /// No description provided for @depositInstructionSendOnly.
  ///
  /// In en, this message translates to:
  /// **'Send only {currency} on {chain} to this address'**
  String depositInstructionSendOnly(Object currency, Object chain);

  /// No description provided for @depositInstructionProcessingTime.
  ///
  /// In en, this message translates to:
  /// **'Processing time: 2–15 minutes depending on blockchain'**
  String get depositInstructionProcessingTime;

  /// No description provided for @depositInstructionMinimum.
  ///
  /// In en, this message translates to:
  /// **'Minimum deposit: \$10 USD equivalent'**
  String get depositInstructionMinimum;

  /// No description provided for @depositInstructionAutoLoad.
  ///
  /// In en, this message translates to:
  /// **'• Your card will be loaded automatically'**
  String get depositInstructionAutoLoad;

  /// No description provided for @depositInstructionPushNotification.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @copyQr.
  ///
  /// In en, this message translates to:
  /// **'Copy QR'**
  String get copyQr;
  ...
  /// No description provided for @noChainsAvailableTitle.
  ///
  /// In en, this message translates to:
  /// **'No Chains Available'**
  String get noChainsAvailableTitle;

  /// No description provided for @noChainsAvailableMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @noCardInformationAvailable.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @seeYourCardInfo.
  ///
  /// In en, this message translates to:
  /// **'See your card information'**
  String get seeYourCardInfo;

  /// No description provided for @securityTipDoNotSharePin.
  ///
  /// In en, this message translates to:
  /// **'Do not share your PIN or card details.'**
  String get securityTipDoNotSharePin;

  /// No description provided for @securityTipShopSecureSites.
  ///
  /// In en, this message translates to:
  /// **'Only shop on secure sites (https).'**
  String get securityTipShopSecureSites;

  /// No description provided for @securityTipEnableAlerts.
  ///
  /// In en, this message translates to:
  /// **'Enable alerts and blocking from the app.'**
  String get securityTipEnableAlerts;

  /// No description provided for @securityTipCheckTransactions.
  ///
  /// In en, this message translates to:
  /// **'Check your transactions regularly.'**
  String get securityTipCheckTransactions;

  /// No description provided for @onlyAdminsCanEditGroup.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @unableToDetermineEmail.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @inviteToBMP.
  ///
  /// In en, this message translates to:
  /// **'Invite to BMP'**
  String get inviteToBMP;

  /// No description provided for @inviteDescription.
  ///
  /// In en, this message translates to:
  /// **'Send an invitation to {email} to join BMP and receive USDC payments'**
  ...
  /// No description provided for @transferUsdcViaEmail.
  ///
  /// In en, this message translates to:
  /// **'Transfer USDC via email address'**
  String get transferUsdcViaEmail;
  ...
  /// No description provided for @enterRecipientEmail.
  ///
  /// In en, this message translates to:
  /// **'Please enter recipient email'**
  String get enterRecipientEmail;

  /// No description provided for @validRecipientEmail.
  ///
  /// In en, this message translates to:
  /// **'Please enter a valid email address'**
  String get validRecipientEmail;

  /// No description provided for @cannotSendToYourself.
  ///
  /// In en, this message translates to:
  /// **'Cannot send money to yourself'**
  String get cannotSendToYourself;
  ...
  /// No description provided for @recipientNotOnBMP.
  ///
  /// In en, this message translates to:
  /// **'The recipient isn\'t on BMP yet.'**
  String get recipientNotOnBMP;

  /// No description provided for @recipientNeedsWallet.
  ///
  /// In en, this message translates to:
  /// **'The recipient needs to set up their wallet.'**
  String get recipientNeedsWallet;

  /// No description provided for @incorrectPinAttempts.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @createWalletToProceed.
  ///
  /// In en, this message translates to:
  /// **'Create a wallet to proceed with payments'**
  String get createWalletToProceed;

  /// No description provided for @selectSourceWallet.
  ///
  /// In en, this message translates to:
  /// **'Please select a source wallet.'**
  ...
  /// No description provided for @failedToOpenShareDialog.
  ///
  /// In en, this message translates to:
  /// **'Failed to open share dialog'**
  String get failedToOpenShareDialog;

  /// No description provided for @reviewAndConfirmTransfer.
  ///
  /// In en, this message translates to:
  /// **'Review & confirm your transfer'**
  String get reviewAndConfirmTransfer;
  ...
  /// No description provided for @enterOtpEmail.
  ///
  /// In en, this message translates to:
  /// **'Enter OTP sent to email'**
  String get enterOtpEmail;

  /// No description provided for @enterOtpSms.
  ///
  /// In en, this message translates to:
  /// **'Enter OTP sent via SMS'**
  String get enterOtpSms;
}
    ...
    case 'es':
      {
        switch (locale.countryCode) {
          case 'CO':
            return l10n_es
                .loadLibrary()
                .then((dynamic _) => l10n_es.L10nEsCo());
          case 'MX':
            return l10n_es
                .loadLibrary()
                .then((dynamic _) => l10n_es.L10nEsMx());
        }
        break;
      }
    case 'pt':
