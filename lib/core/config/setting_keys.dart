...
abstract class SettingKeys {
  ...
  static const String appLockKey = 'chat.bmp.app_lock';
  ...
  static const String alwaysShowMessageTimestamps = 'chat.fluffy.always_show_message_timestamps';
}
...
enum AppSettings<T> {
  ...
  pushNotificationsGatewayUrl<String>(
    ...
    'https://push.be-mindpower.net/_matrix/push/v1/notify',
  ),
  ...
  alwaysShowMessageTimestamps<bool>('chat.fluffy.always_show_message_timestamps', true);
