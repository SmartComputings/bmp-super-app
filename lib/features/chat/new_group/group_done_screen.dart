...
class GroupDoneScreen extends StatelessWidget {
  final String groupName;
  final String roomId;

  const GroupDoneScreen({
    super.key,
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    L10n.of(context).yourGroupIsReady(groupName),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        // Pop the done screen first, then navigate to the group
