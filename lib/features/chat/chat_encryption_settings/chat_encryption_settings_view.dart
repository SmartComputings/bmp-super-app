...
import 'package:bmp/shared/utils/beautify_string_extension.dart';
      ...
      builder: (context, _) => Scaffold(
        appBar: AppBar(
          leading: IconButton(
            ...
            onPressed: () => context.go('/mainMenuScreen/rooms/${controller.roomId!}'),
          ),
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int i) =>
                          ...
                          value: !deviceKeys[i].blocked,
                              inactiveThumbColor: deviceKeys[i].verified
                              ? Colors.green
                              : Colors.orange,
                          onChanged: (_) =>
