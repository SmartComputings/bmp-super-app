...
import 'package:bmp/shared/utils/size_string.dart';
...
import 'package:bmp/shared/utils/resize_video.dart';
...
class SendFileDialogState extends State<SendFileDialog> {
    ...
    try {
      if (!widget.room.otherPartyCanReceiveMessages) {
        throw OtherPartyCanNotReceiveMessages(
                 L10n.of(context).otherPartyCannotReceiveEncryptedMessages,
);
      }
  ...
  Widget build(BuildContext context) {
    ...
    if (uniqueFileType == 'image') {
      ...
      // Auto-send images without showing dialog
