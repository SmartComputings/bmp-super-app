...
// import 'package:bmp/shared/utils/fluffy_share.dart';
...
class BootstrapDialogState extends State<BootstrapDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget body = const AdaptiveLoaderWidget();
                      ...
                      onPressed: _recoveryKeyInputLoading
                          ...
                          : () async {
                              ...
                              try {
                                ...
                                // Store recovery key in secure storage after successful unlock
                                await const FlutterSecureStorage().write(
                                  key: _secureStorageKey,
                                  value: key,
                                );
                                Logs().d('Recovery key stored in secure storage');
