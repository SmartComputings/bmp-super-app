...
import 'package:bmp/shared/widgets/hover_builder.dart';
        ...
        return AnimatedSize(
          ...
          child: FutureBuilder(
            ...
            builder: (context, snapshot) {
              ...
              final filteredPresences = presences.where((presence) => !client.ignoredUsers.contains(presence.userid)).toList();
              ...
              return SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: filteredPresences.length,
                  itemBuilder: (context, i) => PresenceAvatar(
                    presence: filteredPresences[i],
                    height: StatusMessageList.height,
